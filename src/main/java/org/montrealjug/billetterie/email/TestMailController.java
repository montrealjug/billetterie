                        ...
                        .orElseGet(
                                () -> {
                                    ...
                                    newEvent.setDescription(
                                            "Test Event for mail notification description");
                        ...
                        .orElseGet(
                                () -> {
                                    ...
                                    newActivity.setDescription(
                                            "Test Activity for mail notification description");
                                            ...
                                            .orElseThrow(
                                                    () ->
                                                            new IllegalStateException(
                                                                    "we should have found the just"
                                                                            + " created booker!"));
                                });

        var bookerParticipantIds =
            ...
            var updatedActivity =
                    activityRepository
                            ...
                            .orElseThrow(
                                    () ->
                                            new IllegalStateException(
                                                    "we should have found the updated activity!"));
            updatedActivity.getParticipants().stream()
                    .filter(ap -> bookerParticipantIds.contains(ap.getParticipant().getId()))
