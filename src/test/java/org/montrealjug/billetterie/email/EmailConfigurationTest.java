...
public class EmailConfigurationTest {
    ...
    void emailConfiguration_should_validate_EmailProperties() {
        var missingProperties = new String[] { VALID_PROPERTIES[0], VALID_PROPERTIES[2], VALID_PROPERTIES[3] };
        contextRunner.withPropertyValues(missingProperties).run(context -> assertThat(context).hasFailed());
        ...
        contextRunner.withPropertyValues(invalidProperties).run(context -> assertThat(context).hasFailed());
    }
