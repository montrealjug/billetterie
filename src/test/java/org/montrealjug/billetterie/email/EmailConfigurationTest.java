...
public class EmailConfigurationTest {
    ...
    private final ApplicationContextRunner contextRunner =
            new ApplicationContextRunner()
                    ...
                    .withBean(
                            ...
                            () -> mock(ResourceBundleMessageSource.class));

    @Test
    void
            emailConfiguration_should_provide_NO_OP_EmailSender_if_no_JavaMailSender_bean_is_available() {
        contextRunner
                ...
                .run(
                        context ->
                                assertThat(context)
                                        ...
                                        .isSameAs(EmailSender.NO_OP));
    }

    @ParameterizedTest
    @ValueSource(strings = {"SMTP"})
    @EmptySource
    void emailConfiguration_should_provide_a_SmtpEmailSender_if_mode_is_SMTP_or_not_defined(
            String mode) {
        contextRunner
                .withPropertyValues(VALID_PROPERTIES)
    ...
    void emailConfiguration_should_validate_EmailProperties() {
        var missingProperties =
                new String[] {VALID_PROPERTIES[0], VALID_PROPERTIES[2], VALID_PROPERTIES[3]};
        contextRunner
                .withPropertyValues(missingProperties)
                ...
                .run(
                        context -> {
                            ...
                            assertThat(from.asInternetAddress())
                                    .satisfies(
                                            ia ->
                                                    assertThat(ia.getAddress())
                                                            .isEqualTo(from.address()))
                                    .satisfies(
                                            ia ->
                                                    assertThat(ia.getPersonal())
                                                            .isEqualTo(from.name()));
                            ...
                            assertThat(replyTo.asInternetAddress())
                                    .satisfies(
                                            ia ->
                                                    assertThat(ia.getAddress())
                                                            .isEqualTo(replyTo.address()))
                                    .satisfies(
                                            ia ->
                                                    assertThat(ia.getPersonal())
                                                            .isEqualTo(replyTo.name()));
                        });
    }
